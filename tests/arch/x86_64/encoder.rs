    ...
    encode_instruction(
        ...
        &Ins::Cmp {
            ops: TwoOperands {
                ...
                src: Operand::U32(0x12),
                size: OperandSize::I32,
            },
            is_postlude: false,
        },
    );
    assert_eq!(objdump(&context.code), "cmp DWORD PTR [rax-0xa],0x12\n");
}
...
fn cmp32_mem32_imm() {
    ...
    assert_eq!(objdump(&context.code), "cmp DWORD PTR [rax-0xa],0x1337\n");
}
